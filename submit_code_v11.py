...
def save_meta():
    meta = dict(
        model=f"HGB({N_SPLITS_KFold}-Fold Ensemble) + 3-seed AvgProba + OrdinalEnc + Calib [Optuna V11.1]", # [V11.1] 모델명
        feature_engineering=[
            ...
            "[V11.1-Fix] Fixed 'g' groupby object refresh order for NA_COUNT" # [V11.1]
        ],
